...
void main() {
  float colourNoise = noise(vec3(vUv, sin(uTime * 0.2)));

  // Changing these values from this site: http://dev.thi.ng/gradients/
  // Use these values: [[0.500 0.500 0.500] [0.666 0.666 0.666] [1.000 1.000 1.000] [0.000 0.333 0.667]]
  vec3 color = palette(colourNoise, vec3(0.5), vec3(0.166), vec3(1.0), vec3(0.0, 0.333, 0.667));
